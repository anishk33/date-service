...
public class DateTimeController {
    ...
    @RequestMapping(value = "/datetime", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "/datetime.text", produces = MediaType.TEXT_PLAIN_VALUE)
    ...
    @RequestMapping(value = "/datetime/random", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "/datetime/random.text", produces = MediaType.TEXT_PLAIN_VALUE)
